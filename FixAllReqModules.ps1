...
$InstallGraphPSModules = @("Microsoft.Graph.Authentication","Microsoft.Graph.Calendar","Microsoft.Graph.DirectoryObjects", "Microsoft.Graph.Identity.DirectoryManagement","Microsoft.Graph.Groups","Microsoft.Graph.Users","Microsoft.Graph.Users.Actions")
